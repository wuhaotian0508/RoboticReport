"""Generate BVH motions with a distilled style-adapter checkpoint."""
...
def main() -> int:
    ...
    parser.add_argument("--checkpoint", default="outputs/finetune_distill/style_adapter_last.pth")
    parser.add_argument("--prompt", default="A person moves like doing tai chi.")
    parser.add_argument("--prompt-file", default=None)
    parser.add_argument("--output-dir", default="outputs/finetune_distill_samples")
    ...
    load_checkpoint(gpt, Path(args.checkpoint), device)
    gpt.eval()
    ...
    for idx, prompt in enumerate(prompts):
        output_file = out_dir / f"evaluate_adapter{idx}.bvh"
